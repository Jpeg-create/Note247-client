      ...
      <div className={styles.authCard}>
        ...
        {params.get('reason') === 'limit' && (
          <div className={styles.limitBanner}>
            Guest document limit reached. Create an account to keep going.
          </div>
        )}

        <div className={styles.e2eeBadge}>
          Your notes are encrypted in your browser. Note247 cannot read them.
        </div>
        ...
        <p className={styles.switchLink} style={{ marginTop: 8 }}>
          Forgot password? <Link to="/recover">Recover with key</Link>
        </p>
      </div>
    </div>
  );
